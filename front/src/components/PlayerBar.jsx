...
const PlayerBar = () => {
  ...
  const repeat    = state?.on_repeat ?? false;
  ...
  return (
      <footer className="fixed bottom-0 w-full z-30"
        ...
        {/* Barra de progreso */}
        <div className="w-full h-1 bg-[#646482]/15 relative group cursor-pointer" onClick={handleSeek}>
        ...
        <div className="flex flex-col px-4 py-2 gap-2 sm:hidden">
          ...
          <div className="flex items-center justify-center gap-6 pb-1">
            ...
            <button onClick={() => cmd('repeat/toggle')} disabled={!track}
                    className={`transition disabled:opacity-20 ${repeat ? 'text-[#8B5CF6]' : 'text-[#646482] hover:text-[#DCDCEB]'}`}>
              <Repeat size={16} />
            </button>
        ...
        <div className="hidden sm:flex items-center justify-between px-6 h-20">
          ...
          <div className="flex items-center gap-5">
            ...
            <button onClick={() => cmd('repeat/toggle')} disabled={!track}
                    className={`transition-all hover:scale-110 disabled:opacity-20 disabled:cursor-not-allowed ${repeat ? 'text-[#8B5CF6]' : 'text-[#646482] hover:text-[#DCDCEB]'}`}>
              <Repeat size={17} />
            </button>
          </div>

          {/* Tiempo + volumen + stop — derecha */}
